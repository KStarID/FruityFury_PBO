...
public class PanelMouseEffect extends JComponent {
    ...
    public final static Color[] colors = new Color[] { Color.decode("#FFC312"), Color.decode("#C4E538"),
            Color.decode("#12CBC4"), Color.decode("#FDA7DF"), Color.decode("#ED4C67"), Color.decode("#009432"),
            Color.decode("#0652DD"), Color.decode("#9980FA"), Color.decode("#006266") };
